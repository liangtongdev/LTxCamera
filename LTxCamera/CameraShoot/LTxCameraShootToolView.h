...
#define LTX_CAMERA_SHOOT_VIEW_ACTION_BACKGROUND_WIDTH 75
#define LTX_CAMERA_SHOOT_VIEW_ACTION_FORGROUND_WIDTH  (LTX_CAMERA_SHOOT_VIEW_ACTION_BACKGROUND_WIDTH - 20)
#define LTX_CAMERA_SHOOT_VIEW_ACTION_BUTTON_WIDTH 70
#define LTX_CAMERA_SHOOT_VIEW_ACTION_BUTTON_PADDING 40
#define LTX_CAMERA_SHOOT_VIEW_ANIMATE_DURATION .1
